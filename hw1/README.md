...
Both [main.py](./main.py) and [main.cpp](./main.cpp) implement the same DFS algorithm that finds the steps the frogs need to take to switch places.

## Python

The first implementation of the algorithm was made in Python
